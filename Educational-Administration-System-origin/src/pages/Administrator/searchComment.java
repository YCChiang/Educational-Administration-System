...
public class searchComment {
	...
	TeacherInformationServiceimpl teahcerinfoservice;
	...
	private boolean test() {
		teahcerinfoservice = new TeacherInformationServiceimpl();
		classinfoservice = new ClassInfoServiceImpl();
		Teacher t = teahcerinfoservice.findById(textField.getText());
		if(t==null) {
			JOptionPane.showMessageDialog(null, "无本教师", "错误", JOptionPane.ERROR_MESSAGE);
			return false;
		}
		ClassInfo c= classinfoservice.findOne(textField_1.getText());
		if(c==null) {
			JOptionPane.showMessageDialog(null, "无本课程", "错误", JOptionPane.ERROR_MESSAGE);
			return false;
		}
		return true;
	}
	...
	private void initialize() {
				...
				if (e.getSource() == button)
					if (validate()) {
						if (test()) {
							...
							List<Comment> list = service.findCommentListbyteacheridandclassid(textField.getText(),
									textField_1.getText());
							if (list.isEmpty()) {
		...
		groupLayout.setHorizontalGroup(groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING,
						groupLayout.createSequentialGroup().addContainerGap(182, Short.MAX_VALUE).addComponent(label)
								.addGap(178))
				.addGroup(groupLayout.createSequentialGroup().addGap(89)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
								.addGroup(groupLayout.createSequentialGroup().addComponent(button).addGap(57)
										.addComponent(empty).addGap(54).addComponent(button_2))
		...
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addGap(30).addComponent(label).addGap(46)
				...
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(button_2)
						.addComponent(button).addComponent(empty))
				.addContainerGap()));
